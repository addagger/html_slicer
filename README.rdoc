...
Undefined value or +nil+ assumes it by default regular expression +/&#?\w+;|\S/+. As you can see it counts any regular character or HTML special character as a unit.
