...
* the +nil+ argument assumes it is number +1+.
	...
	<tt>@article_paged.slice!(2)
  # => "ak the silence"</tt>
  
  * the passed slice number is remembered.
  
  <tt>@article_paged.slice!(4)
  # => "rld
  <iframe width="300" height="169" src="http://www.youtube.com/embed/ms0bd_hCZsk" frameborder="0" allowfullscreen></iframe>"</tt>
